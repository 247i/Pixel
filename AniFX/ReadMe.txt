...
AniFX uses non-Unicode language files. 
...
This will allow AniFX to show the language files correctly.
...
Usually each window of AniFX has a separate section. 
...
AniFX uses the Version key when downloading language files.
...
AniFXVersion – The version of AniFX
...
icofxsoftware@gmail.com, so I can post it on the web page of AniFX to be 
